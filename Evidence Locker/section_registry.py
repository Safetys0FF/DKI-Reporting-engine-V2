...
SECTION_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "section_1": {
        ...
        "category": "core",
        "tags": ["objectives", "intake", "client", "subject", "background"],
    ...
    "section_2": {
        ...
        "category": "core",
        "tags": ["planning", "requirements", "pre-surveillance", "briefing"],
    ...
    "section_3": {
        ...
        "category": "core",
        "tags": ["daily-log", "surveillance", "timeline", "field-notes"],
    ...
    "section_4": {
        ...
        "category": "core",
        "tags": ["session-review", "chronology", "analysis", "continuity"],
    ...
    "section_5": {
        ...
        "category": "evidence",
        "tags": ["supporting-documents", "records", "compliance", "reference"],
    ...
    "section_6": {
        ...
        "category": "financial",
        "tags": ["billing", "financial", "hours", "expenses"],
    ...
    "section_7": {
        ...
        "category": "core",
        "tags": ["conclusion", "findings", "decision", "summary"],
    ...
    "section_8": {
        ...
        "category": "evidence",
        "tags": ["media", "photo", "video", "evidence-index"],
    ...
    "section_9": {
        ...
        "category": "compliance",
        "tags": ["certification", "disclaimer", "legal", "compliance"],
