...
# ui_components and file_drop_zone will be passed as arguments if needed
...
class CaseManagementPanel(ttk.Frame):
    ...
    def setup_ui(self):
        ...
        # File management placeholder (FileDropZone can be added by parent)
        self.drop_zone_container = file_mgmt_frame
        self.drop_zone = None
        
        # Basic file selection button as fallback
        ttk.Button(
            file_mgmt_frame,
            text="Select Files",
    ...
    def _basic_file_select(self):
        """Basic file selection dialog (fallback when FileDropZone unavailable)"""
