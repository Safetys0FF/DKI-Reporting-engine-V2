"""Unit tests for Section 2 lifecycle wrapper."""
...
from section_2_framework import Section2Framework, LifecycleState
...
class StubGateway:
    ...
    def get_section_inputs(self, section_id: str) -> Dict[str, Any]:
        ...
        return {
            "case_metadata": {"case_id": "CASE-002"},
            "subject_manifest": [],
            "planning_docs": {},
            "osint_cache": {},
            "toolkit_results": {},
...
class Section2FrameworkTests(unittest.TestCase):
    def _build_section(self) -> Section2Framework:
